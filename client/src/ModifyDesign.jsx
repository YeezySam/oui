...
const ModifyDesign = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-400 to-gray-200">
      {/* Navbar identique à celle du dashboard */}
          ...
          <div className="p-8">
            ...
            <div className="space-y-6">
              {designOptions.map((option, index) => (
                <div
                  key={option.id}
                  className="flex items-center p-6 bg-gray-50 rounded-lg hover:bg-green-50 transition-colors cursor-pointer"
                >
                  ...
                  <div className="ml-4 text-green-500 hover:text-green-700">
                    →
                  </div>
                </div>
              ))}
